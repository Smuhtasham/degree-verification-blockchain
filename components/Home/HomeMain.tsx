...
const HomeMain = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh] bg-black bg-opacity-30">
      <div className="p-6 h-[80vh] w-[40%] border border-solid border-gray-300 rounded-[10px] bg-white">
        <div>
